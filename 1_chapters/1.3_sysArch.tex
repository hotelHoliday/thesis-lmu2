\section{Overview}
    ...
    \HD{Insert photograph of Raspberry-Pi installed on the machine}	
    ...
    \begin{table}[H]
        ...
        \begin{center}
            \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
                ...
                MIC-01 & CLICK & C0-12DRE-2-D & Client-Server & 192.168.0.120 & raspberry\\
